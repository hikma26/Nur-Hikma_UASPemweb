[![Tonton Video Demo](https://img.youtube.com/vi/L1lxlSs4QPg/maxresdefault.jpg)](https://youtu.be/L1lxlSs4QPg)
...
📘 Panduan Penggunaan - Sistem Donor Darah Kabupaten Mamuju Tengah
...
🌍 Hosting Online: https://hikma.mangaverse.my.id
👤 Untuk Pengguna (Pendonor)
1. 🔐 Registrasi & Login
➕ Registrasi
Klik tombol "Daftar" pada halaman login
Isi data: Nama, Email, Username, Password
Klik "Daftar"
🔑 Login
Akses halaman login
...
5. 👤 Kelola Profil
Klik nama akun (pojok kanan atas) → "Profil"
Ubah informasi: Nama, Email, Password
